...
%%
%%\end{listingsboxJava}
%In der Spring-basierten Web-Anwendung muss der Spring Core Container, in dem Beans definiert sind und diese per Dependency Injection zusammengebracht werden, über einen \texttt{ApplicationContext} erzeugt werden.
%\begin{listingsboxJava}[label={lst:X}]{myJava}{Web-Anwendung starten}
