...
\section{Fachliche Spezifikation}\label{fachSpez}
...
\section{Skript zur Erstellung einer Replikationsgruppe}\label{replSet}
...
\section{Skript zur Erstellung von Shards, mit je einer Replikationsgruppe}\label{shardSys}
...
\begin{listingsboxJavaScript}[label={lst:createShards2}]{myJS}{Skript erzeugt drei Shards, mit je einer Replikationsgruppe inklusive 3 Server, Teil 2}
...
\begin{listingsboxJavaScript}[label={lst:createShards3}]{myJS}{Skript erzeugt drei Shards, mit je einer Replikationsgruppe inklusive 3 Server, Teil 3}
