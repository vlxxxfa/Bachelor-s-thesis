...
Angular 2 ist komplett in TypeScript entwickelt worden. TypeScript ist eine JavaScript-Erweiterung von Microsoft, die JavaScript um statisches Typsystem und objektorientierten Programmierstil über die Nutzung von Interfaces, Klassen, Module etc. erweitert\footnote{TypeScript Documentation, \url{http://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-2.html}, zugegriffen am 3. März 2017}.
