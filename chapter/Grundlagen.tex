...
\subsection{\colorbox{yellow}{Horizontale Skalierbarkeit}}
...
\section{\colorbox{green}{Wartbarkeit}}\label{maintenance}
...
\subsection{\colorbox{green}{Die SOLID-Prinzipien}}\label{solid}
...
\subsection{\colorbox{green}{Dependency Injection (DI)}}\label{di}
...
\subsection{\colorbox{green}{MVC-Pattern}}\label{mvc}
...
\subsubsection{\colorbox{green}{Workflow}}
...
\subsubsection{\colorbox{green}{Beobachter Muster}}\label{observer}
