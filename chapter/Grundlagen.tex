...
Spring Framework besteht aus Modulen, die möglichst unabhängig den Entwicklern zur Verfügung stehen. Die zwei davon werden für den Prototyp angewendet.
...
Um Spring Framework in einer Java Anwendung verwenden zu können, müssen die entsprechenden Bibliotheken dem Java Projekt hinzugefügt werden. Listing \ref{lst:pom} zeigt ein Beispiel für eine Maven\footnote{\url{https://maven.apache.org}, zugegriffen am 20.2.2017}-Konfigurationsdatei, in der benötigte Bibliotheken für Spring deklariert sind.
